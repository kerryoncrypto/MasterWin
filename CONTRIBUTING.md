Contributing to MasterWin
============================

The MasterWin project operates an open contributor model where anyone is
...
The following applies to code changes to the MasterWin project, and is not to be
confused with overall MasterWin Network Protocol consensus changes.

Whether a pull request is merged into MasterWin rests with the project merge
...
Patches that change MasterWin consensus rules are considerably more involved than
...
Where a patch set proposes to change the MasterWin consensus, it must have been
...
The project leader is the release manager for each MasterWin release.
