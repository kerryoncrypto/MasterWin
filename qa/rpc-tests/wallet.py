...
#   c) node1 mines 32 blocks, so now node 0 has 60001MW, node 1 has 4250MW, node2 has none.
#   d) node0 sends 601 MW to node2, in two transactions (301 MW, then 300 MW).
