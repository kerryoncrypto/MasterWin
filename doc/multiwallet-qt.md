...
In order to support loading of multiple wallets in masterwin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is masterwin.cpp.
...
Changes to masterwin.cpp
----------------------
masterwin.cpp is the entry point into masterwin-qt, and as such, will require some minor modifications to provide hooks for
